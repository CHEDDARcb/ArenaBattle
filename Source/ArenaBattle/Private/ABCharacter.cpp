...
AABCharacter::AABCharacter()
{
	...
	CharacterStat = CreateDefaultSubobject<UABCharacterStatComponent>(TEXT("CHRACTERSTAT"));
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance> WARRIOR_ANIM(TEXT("AnimBlueprint'/Game/Animations/WorriorAnimBlueprint.WorriorAnimBlueprint_C'"));
...
void AABCharacter::SetWeapon(AABWeapon* NewWeapon)
{
	...
	{
		NewWeapon->AttachToComponent(GetMesh(), FAttachmentTransformRules::SnapToTargetIncludingScale, WeaponSoket);
